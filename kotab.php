...
<div class="intro">
 <div class="jumbotron">
  <div class="container-fluid">
    <h1>نبذة عن الكتاتيب الصيفية</h1>
    <p> الكتاتيب الصيفية هي أحد مناشط الجمعية القرآنية , و تشمل جميع مساجد آجيم و ضواحيها و ههذا النشاط ليس بجديد بل إنما إعتدناه على طول سنوات إلا إننا الآن نسحى لدعم هذا النشاط و و تحسين جودة الكتاتيب , و لن يتيسر لنا الطريق لذلك إلا بدعمكم و تشيعكم لنا معنويا و ماديا  ففي النهاية هذا المشروع هو مشروع الجميع </p>
  </div>
 </div>
</div>
